...
plt.xlabel("1 = No Disease, 0 = Disease (Target result for myocarditis in Covid-19 patients)")
plt.ylabel("Number of estimator(count)")
...
plt.xlabel("1 = No Disease, 0 = Disease (Target based on Sex)")
plt.ylabel("Number of estimator(count)")
